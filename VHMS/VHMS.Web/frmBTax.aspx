<%@ Page Title="Tax" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmBTax.aspx.cs" Inherits="frmBTax" %>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group" id="divPercentage">
                                <label>
                                    Percentage</label><span class="text-danger">*</span>
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-rupee"></i></div>
                                    <input type="text" class="form-control decimal" id="txtPercentage" placeholder="Please enter Percentage"
    ...
    <script type="text/javascript">
        ...
        $("#btnSave,#btnUpdate").click(function () {
            ...
            if ($("#txtPercentage").val().trim() == "" || $("#txtPercentage").val().trim() == undefined) {
                $.jGrowl("Please enter Percentage", { sticky: false, theme: 'warning', life: jGrowlLife });
                $("#divPercentage").addClass('has-error'); $("#txtPercentage").focus(); return false;
            } else { $("#divPercentage").removeClass('has-error'); }

            var Obj = new Object();
            Obj.TaxID = 0;
            Obj.TaxName = $("#txtName").val().trim();
            Obj.TaxPercentage = parseFloat($("#txtPercentage").val());
        ...
        function ClearFields() {
            ...
            $("#divPercentage").removeClass('has-error');
            return false;
        }
                            ...
                            if (objResponse.Value != null && objResponse.Value != "NoRecord") {
                                ...
                                if (obj.length > 0) {
                                    ...
                                    for (var index = 0; index < obj.length; index++) {
                                        ...
                                        table += "<td class='hidden-xs'>" + parseFloat(obj[index].TaxPercentage).toFixed(2) + "</td>";
                        ...
                        if (objResponse.Status == "Success") {
                            if (objResponse.Value != null && objResponse.Value != "NoRecord" && objResponse.Value != "Error") {
                                ...
                                if (obj != null) {
                                    ...
                                    $("#txtPercentage").val(obj.TaxPercentage.toFixed(2));
