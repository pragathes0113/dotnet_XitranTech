<%@ Page Title="Sales Summary Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmSalesReport.aspx.cs" Inherits="frmSalesReport" %>
            ...
            <section class="content">
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-2" id="Company">
                                    ...
                                    <asp:DropDownList ID="ddlCompany" CssClass="select2" Width="200" Height="30" runat="server">
                                    </asp:DropDownList>
                                </div>
                                <div class="form-group col-md-2" id="divPaymentMode" style="display: none">
                                    ...
                                    <asp:DropDownList ID="ddlPaymentMode" AutoPostBack="false" Width="200" Height="30" runat="server" CssClass="select2">
                                        ...
                                        <asp:ListItem Text="DSales" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="Cash Bill" Value="2"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvSales" runat="server" Caption="Sales Summary Reports" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
