<%@ Page Title="FollowUp" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmFollowUp.aspx.cs" Inherits="frmFollowUp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
        ...
        <section class="content">
            ...
            <div class="box box-primary" id="divOPBilling">
                <div class="box-header with-border">
                    <div class="box-title">FollowUp Information</div>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="form-group col-md-4" id="divNewCustomer">
                            <label>FollowUp Customer</label><span class="text-danger">*</span>
    ...
    <script src="UserDefined_Js/jFollowUp.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/jFollowUp.js") %>" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        var pageUrl = '<%=ResolveUrl("~/frmFollowUp.aspx") %>';
