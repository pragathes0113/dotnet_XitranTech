<%@ Page Title="Sales Return Detailed Report" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmSalesReturnDetailedReport.aspx.cs" Inherits="frmSalesReturnDetailedReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
    ...
    <div class="container-wrapper">
        <section class="content-header">
            <h1>Sales Return Detailed Report
            </h1>
            <ol class="breadcrumb">
                <li><a href="frmDefault.aspx"><i class="fa fa-home"></i>Home</a></li>
                <li><a href="#">Report</a></li>
                <li class="active">Sales Return Detailed Report</li>
            </ol>
            ...
            <section class="content">
                ...
                <table border="0" class="table table-striped table-bordered table-responsive dTableR">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-2" id="divDOR">
                                   ...
                                   <div class="form-group col-md-2" id="Product">
                                    <label>
                                ...
                                <div class="form-group col-md-2" id="divPaymentMode" style="display:none;">
                                    ...
                                    <asp:DropDownList ID="ddlPaymentMode" AutoPostBack="false" Width="200" Height="30" runat="server" CssClass="select2">
                                        <asp:ListItem Text="Sales Return" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="DSales Return" Value="1"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                    ...
                    <div class="row" id="divRecords">
                        <asp:GridView ID="gvSalesReturn" runat="server" Caption="Sales Return Detailed Report" CaptionAlign="Top" CssClass="table table-striped table-bordered table-responsive dTableR"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="TaxPercent" ReadOnly="true" DataField="TaxPercent" />
