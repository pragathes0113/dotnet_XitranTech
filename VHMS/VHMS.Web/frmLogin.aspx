...
<head id="Head1" runat="server">
    ...
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no'
        name='viewport' />
    <title>Xitran Technologies | Sign in</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="col-lg-4 col-md-6 col-sm-8">
                ...
                <div class="row loginbox">
                    <div id="divTitle" runat="server"> Xitran Technologies v 1.0.0.0</div>
                    <br />
                    <div class="col-lg-12">
    ...
    <form id="form1" runat="server">
        <div class="container" style="width: 100%; display: flex; height: 100vh; padding: 0px;">
            ...
            <div class="col-sm-6">
                <img src="images/Xitran.jpg" style="margin: auto; display: block; transform: translate(-50%, -50%); position: absolute; left: 60%; top: 40%; width: 500px;" alt="Logo" />
            </div>
