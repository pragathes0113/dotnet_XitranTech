<%@ Page Title="History Of Cancel" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmHistoryOfCancel.aspx.cs" Inherits="frmHistoryOfCancel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
        ...
        <section class="content">
            ...
            <div class="box box-primary" id="divOPBilling">
                <div class="box-header with-border">
                    <div class="box-title">History Of Cancel Information</div>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="form-group col-md-4" id="divNewCustomer">
                            <label>History Of Cancel Customer</label><span class="text-danger">*</span>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3" id="divNote">
                            <label for="txtNote"><strong>Note</strong> <span class="text-danger">*</span></label>
                            <textarea id="txtNote" class="form-control" maxlength="250" tabindex="7" rows="6" placeholder="Enter your note here"></textarea>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group col-md-4" id="divWeek">
                                <select class="form-select" id="ddlWeek" tabindex="12">
                                    <option value="">Select</option>
                            ...
                            <div class="form-group col-md-4" id="divCallStatus">
                                <select class="form-select" id="ddlCallStatus" name="status" tabindex="13">
                                    <option value="">Select</option>
                            ...
                            <div class="form-group col-md-4" id="divGSTAmount">
                                <input type="text" class="form-control" id="txtGSTAmount" placeholder="GST Amount"
                                    maxlength="14" tabindex="13" value="0" onkeypress="return IsNumeric(event)" autocomplete="off" />
                            </div>
                            <div class="form-group col-md-6"></div>
                            <div class="form-group col-md-2">
                                <label>
                            ...
                            <div class="form-group col-md-4" id="divNetAmount">
    ...
    <script src="UserDefined_Js/jHistoryOfCancel.js?v=<%= BaseConfig.GetFileHash("UserDefined_Js/jHistoryOfCancel.js") %>" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        var pageUrl = '<%=ResolveUrl("~/frmHistory Of Cancel.aspx") %>';
