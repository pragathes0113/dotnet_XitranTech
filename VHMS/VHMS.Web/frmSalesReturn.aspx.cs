...
public partial class frmSalesReturn : BaseConfig
{
    ...
    public static string saveimage(string data)
    {
        ...
        String path = HttpContext.Current.Server.MapPath("~/images/Documents/WholeSalesReturn");
        string imgPath = Path.Combine(path, imageName);
        File.WriteAllBytes(imgPath, imgarr);
        return "images/Documents/WholeSalesReturn/" + imageName;
    }
}