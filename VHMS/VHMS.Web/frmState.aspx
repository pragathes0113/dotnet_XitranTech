<%@ Page Title="State" Language="C#" MasterPageFile="~/VHMSMasterPage.master" AutoEventWireup="true" CodeFile="frmState.aspx.cs" Inherits="frmState" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VHMSWebContent" runat="Server">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group" id="divCountry">
                                ...
                                <select id="ddlCountry" class="form-control select2" data-placeholder="Select Country" tabindex="1">
                                </select>
                            </div>
                            <div class="form-group" id="divName">
                                <label>
                                    State</label><span class="text-danger">*</span>
                                <input type="text" class="form-control" id="txtName" placeholder="Please enter State Name"
    ...
    <script type="text/javascript">
        ...
        $("#btnAddNew").click(function () {
            ...
            $("#btnSave").show();
            $("#btnUpdate").hide();
            $(".modal-title").html("<i class='fa fa-plus-square'></i>&nbsp;&nbsp;Add State");
        ...
        $("#btnSave,#btnUpdate").click(function () {
            ...
            if ($("#txtName").val().trim() == "" || $("#txtName").val().trim() == undefined) {
                $.jGrowl("Please enter State", { sticky: false, theme: 'warning', life: jGrowlLife });
            ...
            objCountry.CountryID = $("#ddlCountry").val();
            Obj.Country = objCountry;

            Obj.StateID = 0;
            Obj.StateName = $("#txtName").val().trim();
            Obj.StateCode = $("#txtCode").val();
            Obj.IsActive = $("#chkStatus").is(':checked') ? "1" : "0";

            var sMethodName;
            if ($("#hdnID").val() > 0) {
                Obj.StateID = $("#hdnID").val();
                sMethodName = "UpdateState";
            }
            else { sMethodName = "AddState"; }

            SaveandUpdateState(Obj, sMethodName);
                            ...
                            if (objResponse.Value != null && objResponse.Value != "NoRecord") {
                                ...
                                if (obj.length > 0) {
                                    ...
                                    for (var index = 0; index < obj.length; index++) {
                                        ...
                                        var table = "<tr id='" + obj[index].StateID + "'>";
                                        table += "<td>" + (index + 1) + "</td>";
                                        table += "<td>" + obj[index].Country.CountryName + "</td>";
                                        table += "<td>" + obj[index].StateName + "</td>";
                                        table += "<td class='hidden-xs'>" + obj[index].StateCode + "</td>";
                                        table += "<td class='hidden-xs'>" + TypeStatus + "</td>";

                                        if (ActionView == "1")
                                        { table += "<td style='text-align:center;'><a href='#' id=" + obj[index].StateID + " class='View' title='Click here to View'><i class='fa fa-lg fa-clone text-yellow'/></a></td>"; }
                                        else { table += "<td></td>"; }

                                        if (ActionUpdate == "1")
                                        { table += "<td style='text-align:center;'><a href='#' id=" + obj[index].StateID + " class='Edit' title='Click here to Edit'><i class='fa fa-lg fa-edit'/></a></td>"; }
                                        else
                                        { table += "<td></td>"; }

                                        if (ActionDelete == "1")
                                        { table += "<td style='text-align:center;'><a href='#' id=" + obj[index].StateID + " class='Delete' title='Click here to Delete'><i class='fa fa-lg fa-trash-o text-red'/></a></td>"; }
                                        else
                                        { table += "<td></td>"; }
                                    ...
                                    $(".View").click(function () {
                                        if (ActionView == "1") {
                                            ...
                                            $(".modal-title").html("<i class='fa fa-clone'></i>&nbsp;&nbsp;View State");
                                            $("#btnSave").hide();
                                            $("#btnUpdate").hide();
                                        }
                                        else {
        ...
        function SaveandUpdateState(Obj, sMethodName) {
            $.ajax({
                type: "POST",
                ...
                success: function (data) {
                    if (data.d != "") {
                        ...
                        if (objResponse.Status == "Success") {
                            ...
                            else if (objResponse.Value == "State_A_01" || objResponse.Value == "State_U_01") {
                        ...
                        if (objResponse.Status == "Success") {
                            if (objResponse.Value != null && objResponse.Value != "NoRecord" && objResponse.Value != "Error") {
                                ...
                                if (obj != null) {
                                    ...
                                    $("#hdnID").val(obj.StateID);
                                    $("#ddlCountry").val(obj.Country.CountryID).change();
                                    $("#txtName").val(obj.StateName);
                                    $("#txtCode").val(obj.StateCode);

                                    $("#chkStatus").prop("checked", obj.IsActive ? true : false);

                                    $('#compose-modal').modal({ show: true, backdrop: true });
                                    $(".modal-title").html("<i class='fa fa-pencil'></i>&nbsp;&nbsp;Edit State");
                                }
                                dProgress(false);
                            }
                            else if (objResponse.Value == "NoRecord") {
        ...
        function DeleteRecord(id) {
            $.ajax({
                type: "POST",
                url: "WebServices/VHMSService.svc/DeleteState",
                data: JSON.stringify({ ID: id }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                async: false,
                success: function (data) {
                    if (data.d != "") {
                        ...
                        if (objResponse.Status == "Success") {
                            ...
                            else if (objResponse.Value == "State_R_01" || objResponse.Value == "State_D_01") {
